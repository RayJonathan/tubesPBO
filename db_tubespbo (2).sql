...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2022 at 12:42 AM
...
INSERT INTO `admin` (`id_admin`, `username`, `lastname`, `email`, `status_user`, `password`, `firstname`) VALUES
...
('C004', '123', 'Hendra', 'Aiden', 'hendraaiden@gmail.com', 'CUSTOMER', 0, 70000, '123'),
...
('RE001', 'R001', '2022-12-02'),
('RE002', 'R002', '2022-02-12'),
('RE003', 'R003', '0000-00-00');
...
('RD001', 'RE001', 'M001', 5, 'DELIVERED', 600000),
('RD002', 'RE002', 'M001', 6, 'DELIVERED', 630000),
('RD003', 'RE003', 'M001', 7, 'DELIVERED', 660000);
...
INSERT INTO `transaction` (`id_transaction`, `id_receipt`, `id_discount`, `total`) VALUES
('TRA001', 'RE001', 'D001', 1000000),
('TRA002', 'RE002', 'D002', 1300000),
('TRA003', 'RE003', 'D003', 3000000);
